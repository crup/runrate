...
const addFilterOptions = (command: Command): Command =>
  command
...
const addExportOptions = (command: Command): Command =>
...
addFilterOptions(
  program
    ...
    .description("Open the realtime web dashboard")
    .option("--port <port>", "preferred local HTTP port", "43871")
...
addExportOptions(program.command("export").description("Export usage as JSON or NDJSON"))
